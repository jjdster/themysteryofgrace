...
const initialBooks: BookType[] = [
  // Scripture
  { id: 'kjv', title: 'King James Bible (1611)', filename: 'KJV_Bible.pdf', author: 'King James Bible', downloadUrl: 'https://github.com/jjdster/grace-library-assets/blob/main/KJV_Bible.pdf' },
