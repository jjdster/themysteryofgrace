...
const AIGuide = ({ 
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const prompt = `
        ...
        2. Do not answer from general AI memory if the source text or scripture provides an answer.
        3. If a concept is not supported by the selected sources, say so clearly.
        4. Be educational, encouraging, and clear.
        5. ${isLeaderMode ? "You are in LEADER MODE. Provide additional facilitator notes and deeper theological insights for a small group setting." : "You are in SOLO MODE. Focus on helping the individual student grasp the core concepts."}
  ...
  return (
    <div className="bg-white rounded-2xl border border-primary/10 shadow-sm overflow-hidden flex flex-col h-[500px]">
